    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p class="text-base leading-relaxed text-gray-600 mt-7">The Bookstore application is a comprehensive platform designed to enhance the experience of book lovers and avid readers. .</p>
                ...
                <ul class="flex items-center space-x-3 mt-9">
                    ...
                    <li>
                        <a href="https://github.com/Chetan1921" title="" class="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Subscribe to BookStore</p>
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by Chetan sharma (Devloper) </p>
        <br/>
        <p className='text-sm text-center text-gray-600'> Email:chetan.sharma200104022@gmail.com</p>
        <br/>
        <p className='text-sm text-center text-gray-600'>Phone No:7300844033</p>
    </div>
</section>
